...
# 定义文件路径
pointcloud_path = "F:\\Workspace\\fast-drivable\\GT\\semanticKITTI\\pc\\08_000100.npy"  # 点云文件路径 (.npy 格式)
label_path = "F:\Workspace\\fast-drivable\GT\model_predictions\\08\\000100.npy"  # 标签文件路径 (.npy 格式)
...
def main():
    ...
    boundary_points_filename = "pred_"+ f"boundary_points_{base_filename}.npy"
    ...
    # 保存图像
    plt.savefig("pred_"+f"{base_filename}.png")
